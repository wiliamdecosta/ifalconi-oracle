...
//Initialize Common Variables @0-40722087
...
// Connection Settings @0-25830446

$CONN_TO = $_SESSION["MODULID"];
  ...
  case "2":  
    $CCConnectionSettings = array (
        "Conn" => array(
            "Type" => "Oracle",
            "DBLib" => "OracleOCI",
            "Database" => "192.168.1.101:1521/ORCL",
            "Host" => "192.168.1.101",
            "Port" => "1521",
            "User" => "ifc",
            "Password" => "ifc",
...
//Conn Connection Class @-F5814FA8
class clsDBConn extends DB_Adapter
{
    function clsDBConn()
    {
        $this->Initialize();
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["Conn"]);
        parent::Initialize();
...
//CCGetUserLogin @0-2D6B7A25
function CCGetUserLogin()
{
    return CCGetSession("UserName");
}
//End CCGetUserLogin
