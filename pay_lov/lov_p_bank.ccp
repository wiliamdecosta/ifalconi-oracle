...
OR upper(description) LIKE upper('%{s_keyword}%') ">
			<Components>
				...
				<Hidden id="13" fieldSourceType="DBColumn" dataType="Float" html="False" name="p_bank_id" fieldSource="p_bank_id" wizardCaption="ID" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="GRIDp_bank_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_p_bank_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_p_bank.php" forShow="True" url="lov_p_bank.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
